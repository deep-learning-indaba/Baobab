...
class RegistrationComponent extends Component {
  ...
  render() {
    ...
    if (registrationNotAvailable) {
      return <div className="bg-warning/10 text-warning-text border border-warning-border p-4 rounded-xl text-sm w-full text-center mt-6">
                    ...
                    .map(question => {
                      return (
                        <div
                          ...
                          <h5 className="font-semibold text-foreground text-sm">{question.is_required && <span className="text-error mr-1">*</span>}{question.headline}</h5>
                          {this.formControl(
                            question.id,
                            question,
                            this.state.answers &&
