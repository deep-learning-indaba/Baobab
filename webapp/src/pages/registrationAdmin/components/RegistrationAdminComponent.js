...
class RegistrationAdminComponent extends Component {
  ...
  getUnconfirmed = () => {
    registrationAdminService
      .getUnconfirmed(this.props.event ? this.props.event.id : 0)
      .then((response) => {
        this.setState(
          {
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        id: "affiliation",
        Header: (
          <div className="registration-admin-affiliation">Affiliation</div>
        ),
      ...
      },
      {
        id: "createdAt",
        Header: (
          <div className="registration-admin-createdat">
