...
class RegistrationAdminComponent extends Component {
    ...
    getUnconfirmed = () => {
      registrationAdminService.getUnconfirmed(this.props.event.id).then(response=> {
        this.setState({
      ...
      return (
        <div className="RegistrationAdmin container-fluid pad-top-30-md">
          ...
          <div class="card no-padding-h">
            ...
            <div class="row mb-4">
              <div class="col-12">
                <FormTextBox placeholder="Search Full-name or Email" value={searchTerm} onChange={this.onSearchChange}/>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                ...
                {confirmed && !confirmError && <div class="alert alert-success">{confirmed}</div>}
