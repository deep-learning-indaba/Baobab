            ...
            <div class="status2019 row text-center">
              <div className="col-sm">
                <h5 className={statusClass}>
                  {this.state.applicationStatus === "Submitted" &&
                    this.state.offer && (
                      <span>Your application was successful!</span>
                    )}
                  ...
                  {this.state.applicationStatus === "Submitted" &&
                    ...
                    !this.state.offer &&
                    this.state.invitedGuest !== true && <span>Submitted</span>}

                  {this.state.applicationStatus === "Submitted" &&
                    this.props.event &&
                    !this.props.event.is_application_open &&
                    !this.state.offer &&
                    this.state.invitedGuest !== true && (
                      <span>Waiting List</span>
                    )}

                  {this.state.applicationStatus !== "Submitted" &&
                    this.state.invitedGuest === true && (
                      <span>You've been invited as a guest!</span>
                    )}
                ...
                {this.state.applicationStatus === "Withdrawn" && (
                  <div>
                    Your application has been withdrawn - you will not be
                    considered for a place at {event.description}.<br />
                    <br />
                    <NavLink
                      to={`${this.props.event.key}/apply`}
                ...
                {this.state.applicationStatus === "NOT Submitted" && (
                  <p>
                    You did not submit an application to attend{" "}
                    {event.description}.
                  </p>
                )}

                {this.state.applicationStatus === "Not Started" &&
                  this.state.invitedGuest !== true &&
                  this.props.event &&
                  !this.props.event.is_application_open && (
                    <p>You did not apply to attend {event.description}.</p>
                  )}
