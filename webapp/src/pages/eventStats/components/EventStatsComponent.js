...
class EventStatsComponent extends Component {
  ...
  componentDidMount() {
    eventStatsService
      .getStats(this.props.event ? this.props.event.id : 0)
      .then((result) => {
        this.setState({
          loading: false,
          buttonLoading: false,
          ...
          <div className="col-md">
            <div className="stats-title">
              ...
              {this.getStatus(
                ...
                this.props.event.is_application_opening
              )}
            </div>
            ...
            >
              ...
              <div className="row">
                <div className="col-sm">
                  <h3>
                    {stats.num_responses -
                      stats.num_submitted_responses -
                      stats.num_withdrawn_responses}
                  </h3>
          ...
          <div className="col-md">
            <div className="stats-title">
              ...
              {this.getStatus(
                ...
                this.props.event.is_review_opening
              )}
            </div>
            <div
              className={
                "card" +
                (this.props.event.is_review_opening ? " stats-not-open" : "")
              }
            >
              ...
              {this.plotTimeSeries(
                t("Completed"),
                stats.reviews_complete_timeseries
              )}
            </div>
          </div>
          <div className="col-md">
            <div className="stats-title">
              ...
              {this.getStatus(
                ...
                this.props.event.is_offer_opening
              )}
            </div>
            <div
              className={
                "card" +
                (this.props.event.is_offer_opening ? " stats-not-open" : "")
              }
            >
              ...
              {this.plotTimeSeries(
                t("Accepted"),
                stats.offers_accepted_timeseries
              )}
            </div>
          </div>
          <div className="col-md">
            <div className="stats-title">
              ...
              {this.getStatus(
                ...
                this.props.event.is_registration_opening
              )}
            </div>
            <div
              className={
