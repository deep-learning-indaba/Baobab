...
class ResponsePage extends Component {
    ...
    renderSections() {
        ...
        if (applicationForm && applicationData) {
            ...
            .filter(section => dependentQuestionFilter(section, applicationData.answers)).forEach(section => {
    ...
    renderResponses(section) {
        const applicationData = this.state.applicationData;
        const questions = section.questions.filter(q=>dependentQuestionFilter(q, applicationData.answers)).map(q => {
