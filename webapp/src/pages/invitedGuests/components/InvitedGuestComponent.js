...
class InvitedGuests extends Component {
  ...
  getGuestList() {
    invitedGuestServices
      .getInvitedGuestList(this.props.event ? this.props.event.id : 0)
      .then((result) => {
        this.setState({
          loading: false,
  ...
  convertToCsv = (guestList) => {
    ...
    for (var i = 0; i < guestList.length; i++) {
      let fullname =
        guestList[i].user.user_title +
        " " +
        guestList[i].user.firstname +
        " " +
        guestList[i].user.lastname;
  ...
  downloadCsv = () => {
    ...
    var filename =
      "GuestList" + new Date().toDateString().split(" ").join("_") + ".csv";
  ...
  filterByName = (field) => {
    ...
    let tempList = searchList.filter((guest) => {
      ...
      return (
        ...
        (roleSearch === "all" || guest.role === roleSearch)
      );
    });
      ...
      this.setState(
        {
          ...
          successMessage:
            ...
            " " +
            this.props.t("to the guest list"),
          user: {},
          showErrors: false,
          adding: false,
        },
    ...
    return (
      <div className="InvitedGuests container-fluid pad-top-30-md">
        ...
        {this.state.addedSucess && (
          <div class="card flat-card success">{this.state.successMessage}</div>
        )}
            ...
            <div class="row">
              ...
              <div class={threeColClassName}>
                <FormSelect
                  ...
                  defaultValue={
                    this.state.user[validationFields.role.name] || ""
                  }
                ...
                <div class="row">
                  <div className={threeColClassName}>
                    <FormSelect
                      ...
                      defaultValue={
                        this.state.user[validationFields.title.name] || ""
                      }
                  ...
                  <div className={threeColClassName}>
                    <FormTextBox
                      ...
                      value={
                        this.state.user[validationFields.firstName.name] || ""
                      }
                    />
                  </div>
                  ...
                  <div className={threeColClassName}>
                    <FormTextBox
                      ...
                      value={
                        this.state.user[validationFields.lastName.name] || ""
                      }
                    />
                  </div>
                </div>
