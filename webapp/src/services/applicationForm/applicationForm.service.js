...
function getResponse(eventId) {
  return axios
    .get(baseUrl + "/api/v1/response?event_id=" + eventId, {
      headers: authHeader(),
    })
    .then((resp) => {
      let response = null;
...
function submit(applicationFormId, isSubmitted, answers) {
  ...
  return axios
    .post(baseUrl + `/api/v1/response`, response, { headers: authHeader() })
    .then((resp) => {
      return {
...
function updateResponse(response_id, applicationFormId, isSubmitted, answers) {
  ...
  return axios
    .put(baseUrl + `/api/v1/response`, response, { headers: authHeader() })
    .then((resp) => {
      return {
        response_id: resp.data.id,
        is_submitted: resp.data.is_submitted,
...
function withdraw(id) {
  return axios
    .delete(baseUrl + `/api/v1/response`, {
      headers: authHeader(),
      data: { id: id },
    })
    .then((resp) => {
...
export function updateApplicationForm(
  ...
  return axios
    .put(baseUrl + `/api/v1/application-form-detail`, form, {
      headers: authHeader(),
    })
    .then((resp) => {
      return resp;
...
export function createApplicationForm(
  ...
  return axios
    .post(baseUrl + `/api/v1/application-form-detail`, form, {
      headers: authHeader(),
    })
    .then((resp) => {
      return resp;
