    ...
    event = Event(
        {
            ...
            'fr': u'Appel à propositions IAPD: Gestionnaire des programmes de bourses'
        },
        {
        ...
        application_close=datetime.datetime(2020,12,9,5,0,0),  # Equivalent to midnight EST
...
"""
    fr_description = u"""Renforcement des capacités dans les milieux universitaires pour favoriser le développement des talents africains autour de l’intelligence artificielle : Recherche d’un responsable de programme et directeur financier pour le programme de bourses d’études africaines en intelligence artificielle pour le développement (IAPD).
...
"""
    ...
    add_question(org_section, 11, 'short-text', {
        ...
        'fr': u'Pseudonymes sur les médias sociaux (facultatif)'
    }, is_required=False)
    ...
    section1 = add_section({
        ...
        'fr': u'Section I: Capacité organisationnelle et compatibilité avec le programme du gestionnaire de bourses'
    }, None, 3)
    ...
    add_question(section1, 2, 'short-text', {
        ...
        'fr': u'1a. Combien d’entre eux occupent un poste d’employé à temps plein?'
    }, is_required=True)
    ...
    add_question(section1, 3, 'multi-file', {
        ...
        'fr': u'1b. Veuillez fournir le nom et le CV des principaux responsables et administrateurs de votre établissement qui seront chargés d’élaborer et de gérer le programme de bourses africaines d’AI4D (cinq au maximum)'
    }, descriptions={
    ...
    add_question(section1, 4, 'long-text', {
        ...
        'fr': u'2. Expérience et capacité démontrées'
    }, descriptions={
...
(Max. 1000 words)""",
        'fr': u"""Veuillez fournir des exemples d’expériences passées ou actuelles de mise en oeuvre par votre établissement de programmes de bourses ou de subventions destinées à des personnes en Afrique 
(1000 mots au maximum)."""
    ...
    add_question(section1, 5, 'long-text', {
        'en': '2a. Available resources ',
        'fr': u'2a. Ressources disponibles'
    }, descriptions={
...
(750 mots au maximum)."""
    ...
    q2b = add_question(section1, 6, 'multi-choice', {
        'en': '2b. Partnerships plan',
        'fr': u'2b. Plan de partenariats'
    }, descriptions={
    ...
    add_question(section1, 7, 'long-text', {
        ...
        'fr': u'2c. Dans l’affirmative, veuillez brièvement décrire comment vous prévoyez coordonner ces partenariats'
    }, descriptions={
        'en': '(Max. 350 words)',
        'fr': '(350 mots au maximum)'
    }, placeholders={
    ...
    add_question(section1, 8, 'long-text', {
        ...
        'fr': u'3. Expertise pertinente du personnel'
    }, descriptions={
...
(250 mots au maximum)"""
    ...
    add_question(section2, 2, 'long-text', {
        ...
        'fr': u'2. Résumé de l’approche proposée pour la gestion financière et administrative de la bourse d’AI4D'
    }, descriptions={
...
(Max. 1000 words)
""",
        'fr': u"""Décrivez brièvement comment vous proposez de gérer le programme de bourses d’AI4D conformément aux exigences décrites dans la section 2.1 du document de référence de l’appel à propositions. Quelles méthodes, disciplines et modalités allez-vous utiliser à l’appui? 
...
(1 000 mots au maximum)."""
    ...
    add_question(section2, 3, 'long-text', {
        'en': '2a.Communication strategies',
        'fr': u'2a. Stratégies de communication'
    }, descriptions={
...
(Max. 750 words)
""",
        'fr': u"""Discutez du plan de lancement de la bourse de doctorat africaine d’AI4D et du programme de bourses avancées africaines d’AI4D. Comment le plan garantira-t-il que le programme sera aussi inclusif que possible? 
...
(750 mots au maximum)."""
    ...
    add_question(section2, 4, 'long-text', {
        ...
        'fr': u'2b. Suivi, évaluation et apprentissage'
    }, descriptions={
...
(Max. 750 words)""",
        'fr': u"""Discutez de votre stratégie de suivi permanent des programmes de bourses, d’adaptation en fonction des enseignements tirés et des questions émergentes, d’apprentissage pour améliorer les futurs appels à propositions de bourses et d’évaluation de l’impact du programme 
(750 mots au maximum)."""
    }, placeholders={
        'en': 'Enter up to 750 words',
        'fr': u"Entrez jusqu'à 750 mots" 
    ...
    add_question(section2, 5, 'long-text', {
        ...
        'fr': u'3. Conception des plans de bourses '
    }, descriptions={
...
"""
    ...
    add_question(section2, 6, 'long-text', {
        ...
        'fr': u'3a. Considérations liées à la sexospécificité et à l’inclusion'
    }, descriptions={
...
"""
    ...
    add_question(section2, 7, 'long-text', {
        ...
        'fr': u'3b. Processus de sélection et évaluation'
    }, descriptions={
...
(Max. 1000 words)""",
        'fr': u"""Présentez dans les grandes lignes le processus d’évaluation des deux activités de bourses.
...
"""
    ...
    add_question(section2, 8, 'long-text', {
        ...
        'fr': u'4. Plan d’activités complémentaires'
    }, descriptions={
...
(Max. 1000 words)""",
        'fr': u"""Décrivez brièvement le plan des activités complémentaires qui seront élaborées en relation avec les deux programmes de bourses.
...
"""
    ...
    add_question(section2, 9, 'long-text', {
        ...
        'fr': u'5. Considérations d’ordre éthique'
    }, descriptions={
...
(Max. 500 words)""",
        'fr': u"""Veuillez décrire ce à quoi ressemblera la réussite à la fin de la période de trois années. Quels marqueurs utiliserez-vous pour évaluer votrel’initiative IAPD Afrique? Quels sont les résultats escomptés de votre recherche?
(500 mots au maximum)
"""
    }, placeholders={
        'en': 'Enter up to 500 words',
...
"""
    ...
    add_question(section2, 12, 'multi-file', {
        ...
        'fr': u"Veuillez joindre toute documentation supplémentaire qui aidera à clarifier votre demande."
    }, is_required=False)
...
"""
    ...
    fr_desc = u"""Veuillez soumettre un budget triennal complet comprenant des notes en utilisant la feuille Excel qui est disponible sur le site Web public du CRDI, à la page suivante: [https://www.idrc.ca/fr/ressources/guides-et-formulaires](https://www.idrc.ca/fr/ressources/guides-et-formulaires)
