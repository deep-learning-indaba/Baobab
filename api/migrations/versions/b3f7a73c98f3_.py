...
def upgrade():
    ...
    application_form = op.create_table(
        "application_form",
...
def seed_application_form_data(application_form):
    op.bulk_insert(
        application_form,
        [{"id": 1, "event_id": 1, "is_open": True, "deadline": "30 April 2019"}],
    )
    ...
    op.bulk_insert(
        ...
        [
            ...
            },
            {
                ...
                "order": 7,
                "is_required": True,
                "options": [{"selection": "Yes"}, {"selection": "No"}],
            },
            {
                "id": 8,
                "application_form_id": 1,
