...
Pour toute question, veuillez envoyer un e-mail à calls@ai4d.ai"""
    ...
    add_question(section1, 2, 'short-text', {
        ...
        'fr': u'Combien d’employés compte votre organisation en tout?'
    }, descriptions={
    ...
    add_question(section1, 3, 'short-text', {
        ...
        'fr': u'Combien d’entre eux occupent un poste de chercheur en matière de politiques à temps plein?'
    }, is_required=True)
    ...
    add_question(section1, 4, 'multi-file', {
        ...
        'fr': u'Veuillez fournir les noms et les CV des principaux chercheurs de votre organisation (maximum de cinq)'
    }, descriptions={
...
Maximum 250 mots"""
    ...
    add_question(section1, 7, 'long-text', {
        ...
        'fr': u'Veuillez fournir trois à cinq exemples qui témoignent des recherches et des analyses des politiques que vous avez effectuées dans ces domaines. Vous pouvez fournir des liens ou télécharger des documents ou des documents PDF.'
    }, is_required=True)
...
Maximum 350 mots"""
    ...
    add_question(section2, 5, 'long-text', {
        'en': 'Policy research',
        'fr': u'Recherche sur les politiques'
    }, descriptions={
...
Maximum 750 mots"""
    ...
    add_question(section2, 6, 'long-text', {
        ...
        'fr': u'Sexospécificité et inclusion'
    }, descriptions={
...
Maximum 750 words""",
        'fr': u"""Comment votre organisation a-t-elle tenu compte de l’égalité des genres et d’autres dimensions (p. ex. socio-économiques, politiques, culturelles, ethniques) liées à l’inclusion et à la diversité dans sa recherche sur les politiques?
...
"""
    ...
    add_question(section2, 7, 'multi-file', {
        ...
        'fr': u'Sexospécificité et inclusion: Documents justificatifs'
    }, descriptions={
    ...
    add_question(section2, 8, 'long-text', {
        ...
        'fr': u'Considérations d’ordre éthique'
    }, descriptions={
...
Maximum 350 mots"""
    ...
    section3 = add_section({
        ...
        'fr': u'Section III: Expérience en matière d’interaction avec la sphère des politiques'
    }, None, 5)

    add_question(section3, 1, 'long-text', {
        'en': '1. Policy engagement',
        'fr': u'1. Expérience en matière d’interaction avec la sphère des politiques'
    }, descriptions={
...
Maximum 350 mots
    ...
    add_question(section3, 2, 'long-text', {
        ...
        'fr': u'2. Informer les débats et les politiques'
    }, descriptions={
...
Maximum 350 mots"""
    ...
    q3 = add_question(section3, 3, 'multi-choice', {
        ...
        'fr': u'3. Engagement régional'
    }, descriptions={
        'en': """Does your organization also work regionally and/or globally on technology policy related issues?""",
        'fr': u"""Votre organisation travaille-t-elle aussi sur des questions liées aux politiques technologiques à l’échelle régionale ou mondiale?"""
    }, options={
    ...
    add_question(section3, 4, 'long-text', {
        ...
        'fr': u'Engagement régional'
    }, descriptions={
        'en': """Please describe this engagement. List any regional and global networks/association memberships if appropriate
        
Maximum 250 words""",
        'fr': u"""Veuillez décrire la nature de ces travaux. Dressez une liste des associations ou des réseaux auxquels vous appartenez à l’échelle régionale et mondiale, le cas échéant
...
"""
    ...
    fr_desc = u"""Veuillez soumettre un budget triennal complet comprenant des notes en utilisant la feuille Excel qui est disponible sur le site Web public du CRDI, à la page suivante: [https://www.idrc.ca/fr/ressources/guides-et-formulaires](https://www.idrc.ca/en/resources/guides-and-forms)
