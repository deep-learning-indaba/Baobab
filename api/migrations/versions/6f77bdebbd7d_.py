...
Revision ID: 6f77bdebbd7d
Revises: 2717ef90a874
Create Date: 2020-03-10 17:51:18.237709

"""

# revision identifiers, used by Alembic.
revision = '6f77bdebbd7d'
...
def upgrade():
    ...
    about_you_q9 = Question(app_form.id, about_you.id, 'multi-choice', 'Would you be interested in submitting an extended abstract or paper to the Indaba Symposium if you are selected to attend the Indaba?', 'Choose an option', description = 'We won’t hold you to this, it’s just to gauge interest.', validation_regex = None, 9)
    ...
    attendance_q1 = Question(app_form.id, attendance.id, 'multi-check box', 'Did you attend a previous edition of the Indaba?', None, None, is_required = False,
                    options = [
                       {'label': 'Indaba 2017', 'value': 'indaba-2017'},
                       {'label': 'Indaba 2018', 'value': 'indaba-2018'},
                       {'label': 'Indaba 2019', 'value': 'indaba-2019'}
                    ], 1)
    attendance_q2 = Question(app_form.id, attendance.id, 'long-text', 'Tell us how your previous attendance has helped you grow or how you have used what you have learned.', 'Enter up to 150 words', description = 'Enter up to 150 words', validation_regex = '^\s*(\S+(\s+|$)){0,150}$', 2)
    ...
    info_q1 = Question(app_form.id, additional_info.id, 'long-text', 'Any additional comments or remarks for the selection committee', 'Enter up to 80 words', description = 'Enter up to 80 words', validation_regex = '^\s*(\S+(\s+|$)){0,80}$', is_required = False, 1)
    info_q2 = Question(app_form.id, additional_info.id, 'long-text', 'Anything else you think relevant, for example links to personal webpage, papers, GitHub/code repositories, community and outreach activities.', 'Enter up to 80 words', description = 'Enter up to 80 words', validation_regex = '^\s*(\S+(\s+|$)){0,80}$', is_required = False, 2)
    info_q3 = Question(app_form.id, additional_info.id, 'multi-choice', 'If you are selected to attend the Indaba, would you also like to attend the AI Hack Tunisia.', 'Choose an option', description = 'The AI Hack Tunisia will take place in the week of the 31st of August. Accepted Indaba attendees will automatically qualify for a place at the event.', None,
              options = [
                 {'label': 'Yes', 'value': 'yes'},
                 {'label': 'No', 'value': 'no'},
    ...
    session.add_all([info_q1, info_q2, info_q3, info_q4])
