...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "1. Organizational capacity and experience"
    )
    add_information_question(
        form.id,
    ...
    add_information_question(
        form.id,
        form.application_form_id,
        "Of these, how many are full time policy researchers?",
    )
    add_information_question(
        form.id,
        form.application_form_id,
        "Please provide the names and CVs of your organization's principal researchers (up to five)",
        "multi-file",
    )

    review_q1 = add_evaluation_question(
        form.id,
        headlines=None,
        descriptions={
...
""",
    ...
    add_comment_question(
        form.id,
        descriptions={"en": "Comments", "fr": "Des commentaires?"},
        headlines=None,
    )

    add_information_question(
        form.id, form.application_form_id, "2. Mission for Responsible AI"
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "3. Demonstrated expertise"
    )
...
""",
    ...
    add_information_question(
        form.id,
        form.application_form_id,
        "1. Research background, problem statement and justification",
    )
    add_evaluation_question(
        form.id,
        headlines=None,
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "2. General and specific objectives"
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "3. Methodology and approach"
    )
...
Maximum 750 words""",
    ...
    add_information_question(
        form.id,
        form.application_form_id,
        "Gender and inclusion: Supporting documents",
        type="multi-file",
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "Ethical considerations"
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "4. Capacity development"
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "5. Communicating for influence"
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "8. Supplemental documentation (optional)."
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "2. Informing debates and policies"
    )
...
""",
    ...
    add_information_question(
        form.id, form.application_form_id, "3. Regional engagement"
    )
    add_information_question(
        form.id, form.application_form_id, "Regional engagement", heading_override=True
    )
...
""",
    ...
    add_divider(
        form.id,
        headlines={"en": "Section IV: Budget", "fr": "Section IV: Budget"},
        descriptions={
