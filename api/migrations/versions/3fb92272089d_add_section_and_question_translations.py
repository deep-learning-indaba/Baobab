...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('section', sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('section', sa.Column('description', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('section', sa.Column('show_for_values', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    ...
    op.add_column('question', sa.Column('description', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('headline', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('placeholder', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('validation_regex', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('validation_text', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('options', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('question', sa.Column('show_for_values', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
