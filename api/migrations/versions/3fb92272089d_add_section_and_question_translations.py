...
def upgrade():
    ...
    op.execute("INSERT INTO section_translation (section_id, language, name, description) SELECT id, 'en', name, description FROM section")
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(u'section', sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column(u'section', sa.Column('description', sa.VARCHAR(), autoincrement=False, nullable=False))
    ...
    op.add_column(u'question', sa.Column('headline', sa.VARCHAR(), autoincrement=False, nullable=False))
    ...
    # TODO Add data back to original tables
    # ### end Alembic commands ###
