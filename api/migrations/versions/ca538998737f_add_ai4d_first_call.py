...
"""Add AI4F First Call and Application Form

Revision ID: ca538998737f
Revises: 4ec21502ae82
Create Date: 2020-08-25 20:15:34.354046

"""

# revision identifiers, used by Alembic.
revision = "ca538998737f"
down_revision = "4ec21502ae82"
...
def upgrade():
    ...
    event = Event(
        ...
        },
        {
            ...
            "fr": "Centres de Recherche sur les Politiques concernant l’intelligence artificielle (IA) pour le développement en Afrique: Vers une IA responsable grâce à la recherche et à l’élaboration de politiques",
        },
...
Pour toute question, veuillez envoyer un e-mail à calls@ai4d.ai"""
    ...
    section1 = add_section(
        {
            ...
            "fr": "Section 1: Expérience et capacités de l’organisation",
        },
        None,
        3,
    )
    ...
    add_question(
        ...
        "short-text",
        {
            ...
            "fr": "1a. Combien d’entre eux occupent un poste de chercheur en matière de politiques à temps plein?",
        },
        is_required=True,
    )
    ...
    add_question(
        ...
        "multi-file",
        {
            ...
            "fr": "1b. Veuillez fournir les noms et les CV des principaux chercheurs de votre organisation (maximum de cinq)",
        },
        descriptions={
    ...
    add_question(
        ...
        descriptions={
            ...
            "fr": "Veuillez fournir trois à cinq exemples qui témoignent des recherches et des analyses des politiques que vous avez effectuées dans ces domaines. Vous pouvez fournir des liens ou télécharger des documents ou des documents PDF à la fin de la demande.",
        },
        is_required=True,
    )
    ...
    section2 = add_section(
        {
            ...
            "fr": "Section 2: Recherche sur les politiques",
        },
        None,
        4,
    )
    ...
    add_question(
        ...
        5,
        "long-text",
        {"en": "3b. Policy research.", "fr": "3b. Recherche sur les politiques."},
        descriptions={
    ...
    add_question(
        ...
        "long-text",
        {
            ...
            "fr": "3c. Sexospécificité et inclusion.",
        },
        descriptions={
...
Please provide examples [PDF or links] to material that demonstrates your strategy and research on gender, inclusion and diversity. You may upload supporting documents at the end of the application. """,
            "fr": """i. Comment votre organisation a-t-elle tenu compte de l’égalité des genres et d’autres dimensions (p. ex. socio-économiques, politiques, culturelles, ethniques) liées à l’inclusion et à la diversité dans sa recherche sur les politiques?
...
""",
    ...
    add_question(
        ...
        "long-text",
        {
            ...
            "fr": "3d. Considérations d’ordre éthique.",
        },
        descriptions={
    ...
    section3 = add_section(
        {
            ...
            "fr": "Section 3: Expérience en matière d’interaction avec la sphère des politiques",
        },
        None,
        5,
    )
    ...
    add_question(
        ...
        descriptions={
            ...
            "fr": "Veuillez fournir un maximum de trois exemples de ces interactions (p. ex. demandes de consultation, participation à des comités directeurs, réunions avec des décideurs politiques).",
        },
        placeholders={"en": "Enter up to 350 words", "fr": "Entrez jusqu'à 350 mots"},
        validation_regexs={
            "en": r"^\s*(\S+(\s+|$)){0,350}$",
    ...
    q3 = add_question(
        ...
        "multi-choice",
        {
            ...
            "fr": "3. Votre organisation travaille-t-elle aussi sur des questions liées aux politiques technologiques à l’échelle régionale ou mondiale?",
        },
        options={
    ...
    add_question(
        ...
        "long-text",
        {
            ...
            "fr": "3a. Si oui, veuillez décrire la nature de ces travaux. Dressez une liste des associations ou des réseaux auxquels vous appartenez à l’échelle régionale et mondiale, le cas échéant.",
        },
        descriptions=None,
        placeholders={"en": "Enter up to 250 words", "fr": "Entrez jusqu'à 250 mots"},
        validation_regexs={
...
"""
    ...
    fr_desc = """Veuillez soumettre un budget triennal complet comprenant des notes en utilisant la feuille Excel qui est disponible sur le site Web public du CRDI, à la page suivante: https://www.idrc.ca/fr/ressources/guides-et-formulaires
...
"""
    ...
    section4 = add_section(
        {"en": "Section 4: Budget", "fr": "Section 4: Budget"},
