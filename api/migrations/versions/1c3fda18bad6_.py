...
def upgrade():
    ...
    main_section = Section(
        app_form.id,
        "Deep Learning Indaba 2020 Application Form",
    ...
    demographics_q4 = Question(
        ...
        4,
        None,
        description="We collect this information to ensure that we provide suitable facilities at our venue.",
        options=[
    ...
    demographics_q6 = Question(
        ...
        6,
        None,
        description="The department or field of study you fall under at your affiliation",
    )
    ...
    about_you_q8 = Question(
        ...
        description="This can be completed research or research in progress. Remember to include a description of your methodology and any key results you have so far.",
    )
    ...
    about_you_q11 = Question(
        app_form.id, about_you.id, "file", "Upload CV", None, 11, None, is_required=True
    )
    ...
    travel_support_q1 = Question(
        ...
        1,
        None,
        description="Travel awards will be used to cover the costs of return flights to the host city and/or accommodation in shared dorm rooms close to the venue.",
        options=[
    ...
    travel_support_q2 = Question(
        ...
        2,
        None,
        description="Please note that we will only provide flights in the form of a return ticket to and from a single airport on the continent of Africa.",
    )
    ...
    session.add_all(
        [travel_support_q1, travel_support_q2, travel_support_q3, travel_support_q4]
    )
    ...
    attendance_q2.show_for_values = [
        ...
        "indaba-2018",
        "indaba-2019",
        "indaba-2017-indaba-2018",
        "indaba-2017-indaba-2019",
        "indaba-2018-indaba-2019",
    ...
    info_q3 = Question(
        ...
        3,
        None,
        description="The AI Hack Tunisia will take place in the week of the 31st of August. Accepted Indaba attendees will automatically qualify for a place at the event.",
        options=[
            {"label": "Yes", "value": "yes"},
            {"label": "No", "value": "no"},
...
def downgrade():
    ...
    op.get_bind().execute(
        """UPDATE Section SET depends_on_question_id=NULL WHERE application_form_id={}""".format(
            app_form.id
        )
    )
