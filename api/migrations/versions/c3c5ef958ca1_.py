...
Revision ID: c3c5ef958ca1
Revises: c795c179c2b2
Create Date: 2020-03-13 06:58:35.231601
...
def upgrade():
    ...
    event_id = kambulemasters2020.id
...
Details of the person nominating the masters candidate.
    ...
    supporting_q3 = Question(
        ...
        is_required=True,
        description="""
        A supporting letter that describes the main theoretical, methodological, and/or applied contributions of the thesis should be submitted by an academic who is in a position to comment on the merits of the work and the candidate, e.g., Masters supervisor, thesis examiner, academic mentor, collaborators, etc. The letter should be written by someone other than the person who is nominating the candidate.
