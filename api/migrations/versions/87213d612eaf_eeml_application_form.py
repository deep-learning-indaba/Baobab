...
def upgrade():
    ...
    eeml2020 = Event(
        "EEML 2020",
        "Eastern European Machine Learning Summer School 2020, 6-11 July 2020, Krakow, Poland",
...
Do not forget to press Submit once you fill in the application form. It is possible (and recommended!) to submit partially completed forms early on to get familiar with the form, and come back at a later date before the application deadline (20 March 2020, 23:59 Eastern European Time) to edit/complete your responses.
    ...
    personal_q2 = Question(
        ...
        None,
        None,
        description='If you answered "Other", please specify',
        is_required=False,
    )
    personal_q3 = Question(
        app_form.id,
        personal_info.id,
        "Affiliation",
        "Affiliation",
    ...
    research_q1 = Question(
        app_form.id,
        research_interests.id,
        "Research Interests",
        "Enter 500 - 2000 characters",
        1,
        "long-text",
        validation_regex="^.{500,2000}$",
        validation_text="You must enter between 500 and 2000 characters",
    ...
    research_q2 = Question(
        app_form.id,
        research_interests.id,
        "Extended abstract type",
        "Select an option...",
        2,
        "multi-choice",
        None,
    ...
    research_q3 = Question(
        app_form.id,
        research_interests.id,
        "Extended abstract",
        "Upload your extended abstract (pdf, max size 10MB)",
        3,
        "file",
        None,
        is_required=False,
    )
    research_q4 = Question(
        app_form.id,
        research_interests.id,
        "CV",
        "Upload your CV (pdf, max size 10MB)",
        4,
        "file",
        None,
        is_required=True,
    ...
    diversity_q2 = Question(
        ...
        None,
        is_required=False,
        description="Leave blank if you prefer not to answer",
    )
    diversity_q3 = Question(
        app_form.id,
        diversity.id,
        "Nationality",
        "Nationality",
    ...
    financial_support = Section(
        app_form.id,
        "Financial support for attending the school",
        """
...
""",
    ...
    financial_q1 = Question(
        app_form.id,
        financial_support.id,
        "Motivation",
        "Enter up to 500 characters",
        1,
        "long-text",
        validation_regex="^.{0,500}$",
        validation_text="Maximum 500 characters",
        is_required=False,
