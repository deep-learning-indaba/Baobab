...
def find_question(session, headline, application_form_id):
    return (
        ...
        .filter_by(headline=headline, application_form_id=application_form_id)
        .first()
    )
...
def upgrade():
    ...
    project_name_info = ReviewQuestion(
        form.id,
        "information",
        False,
        1,
        question_id=project_name_question.id,
        headline="Project Name",
    )

    proposal_question = find_question(session, "Your Proposal", application_form.id)
    proposal_info = ReviewQuestion(
        form.id, "file", False, 2, question_id=proposal_question.id, headline="Proposal"
    )

    clarity = ReviewQuestion(
        form.id,
        "multi-choice",
        True,
        3,
...
1: research hypothesis is unclear""",
        headline="Clarity and novelty of research hypothesis applying ML/AI/DS",
        options=[
            {"value": 4, "label": "4"},
            {"value": 3, "label": "3"},
            {"value": 2, "label": "2"},
...
""",
    ...
    overall = ReviewQuestion(
        form.id,
        "multi-choice",
        True,
        10,
        description="""Overall evaluation - Do you recommend this proposal for funding?""",
    ...
    confidence = ReviewQuestion(
        form.id,
        "multi-choice",
        True,
        11,
        description="""Your confidence in your assessment""",
        headline="Reviewer's confidence",
        options=[
    ...
    other = ReviewQuestion(
        form.id,
        "long-text",
        True,
        12,
        description="""Any other remarks not covered by previous questions?""",
        headline="Other Remarks",
    )
