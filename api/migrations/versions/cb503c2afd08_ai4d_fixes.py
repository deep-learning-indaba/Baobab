...
"""Fixes for migration ai4d_more_changes

Revision ID: cb503c2afd08
Revises: 78f4d11203c5
Create Date: 2020-09-14 10:52:59.445293

"""

# revision identifiers, used by Alembic.
revision = 'cb503c2afd08'
down_revision = '78f4d11203c5'
...
"""
    ...
    _, en, fr = get_question_by_en_headline('How many people in total work in your organization?')
    ...
    _, en, fr = get_question_by_en_headline('Of these, how many are full time policy researchers?')
    en.validation_regex = r'^\d*$'
    en.validation_text = 'You must enter a number'
    fr.validation_regex = r'^\d*$'
    fr.validation_text = 'Vous devez entrer un nombre'
