...
def upgrade():
    organisation = table(
        ...
        sa.Column("email_from", sa.String(100), nullable=True),
        sa.Column("system_url", sa.String(100), nullable=False),
        sa.Column("privacy_policy", sa.String(100), nullable=False),
