...
def upgrade():
    ...
    op.add_column('registration_question', sa.Column('depends_on_question_id', sa.Integer(), nullable=True))
    op.add_column('registration_question', sa.Column('hide_for_dependent_value', sa.String(), nullable=True))
    op.add_column('registration_question', sa.Column('required_value', sa.String(), nullable=True))
    op.create_foreign_key(None, 'registration_question', 'registration_question', ['depends_on_question_id'], ['id'])
