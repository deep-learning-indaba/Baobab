...
def upgrade():
    ...
    section_en = session.query(SectionTranslation).filter_by(
        name='Section IV: Budget', language='en').first()
...
"""
    ...
    section_en.description = u"""Veuillez soumettre un budget triennal complet comprenant des notes en utilisant la feuille Excel qui est disponible sur le site Web public du CRDI, à la page suivante: [https://www.idrc.ca/fr/ressources/guides-et-formulaires](https://www.idrc.ca/en/resources/guides-and-forms)
...
"""
    ...
    question, en, fr = get_question_by_en_headline('How many people in total work in your organization?')
