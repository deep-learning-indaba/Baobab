...
from app.utils.errors import USER_NOT_FOUND,FAILED_CREATE_INTEGRATION_TEST_USER, FAILED_DELETE_INTEGRATION_TEST_USER
...
class DeleteIntegrationUser(IntegratoonTestDelete,restful.Resource):
    ...
    def post(self):
        try:
            ...
            LOGGER.error(
                'Failed to delete test user {} due to: {}'.format(user, e))
