...
rest_api.add_resource(invoice_api.InvoiceAdminListAPI, '/api/v1/invoice-admin-list')
...
rest_api.add_resource(attendance_api.BlankBadgeAPI, '/api/v1/checkin/blank-badges')
rest_api.add_resource(attendance_api.LinkBadgeAPI, '/api/v1/checkin/link-badge')
