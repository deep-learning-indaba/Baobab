...
from app.guestRegistrations.mixins import (
    GuestRegistrationFormMixin,
...
class GuestRegistrationApi(GuestRegistrationMixin, restful.Resource):
        ...
        try:
            ...
            db_answers = (
                ...
                .filter(
                    ...
                    GuestRegistrationAnswer.is_active == True,
                )
                .all()
            )
    ...
    def post(self):
        ...
        try:
            ...
            email_sent = self.send_confirmation(
                current_user, registration_questions, registration_answers, event
            )
            if email_sent:
    ...
    def put(self):
        ...
        try:
            ...
            registration = (
                db.session.query(GuestRegistration)
                .filter(GuestRegistration.id == args["guest_registration_id"])
                .one_or_none()
            )
            if registration is None:
            ...
            for answer_args in args["answers"]:
                ...
                if answer is not None:
                    ...
                    new_answer = GuestRegistrationAnswer(
                        guest_registration_id=registration.id,
                        registration_question_id=answer_args[
                            "registration_question_id"
                        ],
