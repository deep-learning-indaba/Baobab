...
class Question(db.Model):
    ...
    def _translations_for_field(
        self, accessor_fn: Callable[["QuestionTranslation"], Any]
    ) -> Mapping[str, Any]:
        translations = {}
...
class Section(db.Model):
    ...
    def _translations_for_field(
        self, accessor_fn: Callable[["SectionTranslation"], Any]
    ) -> Mapping[str, Any]:
        translations = {}
...
class SectionTranslation(db.Model):
    ...
    __table_args__ = tuple(
        [db.UniqueConstraint("section_id", "language", name="uq_section_id_language")]
    )
...
class QuestionTranslation(db.Model):
    ...
    __table_args__ = tuple(
        [db.UniqueConstraint("question_id", "language", name="uq_question_id_language")]
    )
