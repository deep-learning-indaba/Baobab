...
class UserApiTest(ApiTestCase):
    ...
    def seed_static_data(self):
        ...
        db.session.flush()
        return test_form, test_section, test_question
    
    def delete_seed_data(self, form, section, question):
        db.delete(form)
        db.delete(section)
        db.delete(question)
        db.flush()
    ...
    def test_get_user(self):
        test_form, test_section, test_question = self.seed_static_data()  
        ...
        self.delete_seed_data(test_form, test_section, test_question)
