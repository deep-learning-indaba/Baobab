...
class RegistrationQuestionMixin(object):
    ...
    req_parser.add_argument('description', type=str, required=False)
    req_parser.add_argument('type', type=str, required=False)
    req_parser.add_argument('placeholder', type=str, required=False)
    req_parser.add_argument('order', type=int, required=False)
    ...
    req_parser.add_argument('options', type=list, required=False)
