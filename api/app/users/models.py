...
class AppUser(db.Model, UserMixin):
    ...
    user_category_id = db.Column(
        db.Integer(), db.ForeignKey("user_category.id"), nullable=True
    )
    ...
    __table_args__ = (
        UniqueConstraint("email", "organisation_id", name="org_email_unique"),
    )
