...
SPEAKER_NOT_FOUND = ({'message': 'No speaker found with the given ID.'}, 404)
SPEAKER_NAME_TAKEN = ({'message': 'A speaker with that name already exists for this event.'}, 409)
SESSION_END_BEFORE_START = ({'message': 'Session end time must be after start time.'}, 400)
MISSING_FIELDS = ({'message': 'Required fields are missing.'}, 400)
