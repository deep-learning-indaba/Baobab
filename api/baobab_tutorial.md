...
1. [Branches](https://git-scm.com/book/en/v2/Git-Branching-Basic-Branching-and-Merging): Each contributor will branch off the main develop branch in order to start submitting proposed changes to the code. The develop branch is the “stable” branch, where all the thoroughly tested code is combined and maintained as the “working” version
